...
//!
//! The Moxa in this case has the communication setup to talk via serial with the device.
//! Our interface on the other hand is simply TCP/IP with an IP address and port.
...
fn main() {
    ...
    let mut inst = Agilent4Uhv::try_new(tcpip_inst).unwrap();
